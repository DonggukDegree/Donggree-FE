 ...
 *  - 리포트는 만들었지만 부정확할 수 있는 경우: 화면은 보여 주되 신뢰도를 알린다. (학점 불일치·학적 유의사항)
 *
...
/** 판정 범위 밖의 복수전공·부전공·편입 정보가 있는 경우. 리포트는 보여 주되 정확도를 안내한다. */
export const UNSUPPORTED_MAJOR_MODAL: TReportModalContent = {
  title: '동그리가 정확한 분석에 실패했어요',
  subtitle: (
    <>
      <span className="text-primary-60">일부 복수전공·부전공·편입</span> 정보는 아직 완전히 판정하지 못해요.
    </>
  ),
  description: `지금 제공하는 리포트는 주전공 기준이며, 정확하지 않을 수 있어요.\n빠른 지원을 원한다면 고객지원에 문의해주세요.`,
};
